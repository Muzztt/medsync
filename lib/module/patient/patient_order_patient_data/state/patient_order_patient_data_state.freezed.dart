...
mixin _$PatientOrderPatientDataState {
  ...
  set successMessage(String? value) => throw _privateConstructorUsedError;
...
class _$PatientOrderPatientDataStateImpl
  ...
  @override
  String toString() {
    return 'PatientOrderPatientDataState(counter: $counter, loading: $loading, errorMessage: $errorMessage, successMessage: $successMessage, orderId: $orderId, name: $name, dob: $dob, gender: $gender, idCard: $idCard, address: $address)';
  }
