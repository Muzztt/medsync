...
class _$PatientOrderListStateImpl implements _PatientOrderListState {
  _$PatientOrderListStateImpl({this.counter = 0});
  ...
  @override
  String toString() {
    return 'PatientOrderListState(counter: $counter)';
  }
...
abstract class _PatientOrderListState implements PatientOrderListState {
  factory _PatientOrderListState({int counter}) = _$PatientOrderListStateImpl;
